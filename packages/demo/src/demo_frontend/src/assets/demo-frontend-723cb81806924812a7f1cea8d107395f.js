...
;define("demo-frontend/actors/demo-backend", ["exports", "ember-cli-dfinity", "demo-frontend/declarations/demo_backend.did"], function (_exports, _emberCliDfinity, _demo_backend) {
  "use strict";
  ...
  var _default = (0, _emberCliDfinity.actorFromIdlFactory)(_demo_backend.idlFactory, 'DemoBackendActor');
...
;define("demo-frontend/components/demo/hello", ["exports", "@ember/component", "@ember/template-factory", "@glimmer/component", "@ember/object", "@glimmer/tracking", "@ember/service", "ember-cli-dfinity"], function (_exports, _component, _templateFactory, _component2, _object, _tracking, _service, _emberCliDfinity) {
  "use strict";
  ...
  */
  ...
  let DemoHelloComponent = (_dec = (0, _emberCliDfinity.actor)({
    ...
    constructor() {
      ...
      _initializerDefineProperty(this, "snackbar", _descriptor6, this);
    }
    validity(valid) {
      this.valid = valid;
    }
    ...
    writable: true,
    initializer: null
  }), _descriptor6 = _applyDecoratedDescriptor(_class.prototype, "snackbar", [_service.inject], {
    configurable: true,
    enumerable: true,
    writable: true,
    initializer: null
...
;define("demo-frontend/helpers/code", ["exports", "@ember/component/helper", "@ember/template"], function (_exports, _helper, _template) {
  "use strict";
  ...
  _exports.default = void 0;
  var _default = (0, _helper.helper)(function code(param) {
    return (0, _template.htmlSafe)(param);
  });
  _exports.default = _default;
});
...
;
          if (!runningTests) {
            require("demo-frontend/app")["default"].create({"name":"demo-frontend","version":"0.0.0+176edb9a"});
          }
