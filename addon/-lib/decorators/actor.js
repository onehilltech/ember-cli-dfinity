...
export default decorator (function actorDecorator (target, name, descriptor, [lookupName, options]) {
  ...
  assert ('You must set the canister or canisterId property on the @actor decorator options.', !!canister || !!canisterId);
